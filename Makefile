...
build-signed_ubuntu20.04%: IMAGE_TAG = $(IMAGE_VERSION)-$(DIST)-$(KERNEL_VERSION)
build-signed_ubuntu20.04%: DOCKER_BUILD_ARGS =  --build-arg KERNEL_VERSION="$(KERNEL_VERSION)"
